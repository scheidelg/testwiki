...
I could potentially write some JavaScript code to access the GitHub API and identify the most commit date for each individual file[#timestamp_java](2).  But that's more work then I want to spend on this particular problem right now.
...
<hr class="tight"><p class="timestamp">Page updated: 2020.03.23 16:09 ET -- Site updated: <span id="timestamp"></span></p>
<script type='text/javascript'>document.getElementById("timestamp").innerHTML = Date(document.lastModified);</script>
